    ...
    <div id="page-top">
        ...
        <div class="container-fluid p-0" style="padding-top: 70px;">
            ...
            <section class="resume-section p-3 p-lg-5 d-flex d-column marginMain" id="about">
                <div class="my-auto">
                    <img src="<?php echo e(asset('web/img/logo-s.png')); ?>" class="img-fluid mb-3" alt="">
...
<?php echo $__env->make('web.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kariem/Documents/projects/dash_1/resources/views/web/pages/home.blade.php ENDPATH**/ ?>