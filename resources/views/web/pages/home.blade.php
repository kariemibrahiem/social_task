                            ...
                            <div class="col-12">
                                ...
                                <div class="whats-news-single mb-40">
                                    <div class="whates-img">
                                        @if($post->image)
                                        <img src="{{ asset($post->image) }}" alt="" style="width: 100%; height: auto;">
                                        @endif
                                    </div>
                                    <div class="whates-caption">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            @if($post->user->image)
                                            <img src="{{ asset($post->user->image) }}" alt="" style="width: 40px; height: 40px; border-radius: 50%; margin-right: 10px;">
                                            @else
                                                ...
                                                <div class="single-comment justify-content-between d-flex mb-3">
                                                    <div class="user justify-content-between d-flex w-100">
                                                        <div class="thumb">
                                                            ...
                                                            <img src="{{ asset($comment->user->image) }}" alt="" style="width: 50px; height: 50px; border-radius: 50%;">
                                                            @else
                                    ...
                                    <div class="weekly2-news-active d-flex">
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                @if($user->image)
                                                <img src="{{ asset($user->image) }}" alt="" style="width: 100%; height: 200px; object-fit: cover;">
                                                @else
