            ...
            @else
                ...
                if (isset($menu->submenu)) {
                    foreach ($menu->submenu as $submenu) {
                        if ($currentRouteName === $submenu->url || str_starts_with($currentRouteName, $submenu->slug)) {
            ...
            <li class="menu-item {{ $activeClass }}" >
                ...
                @isset($menu->submenu)
                    <ul class="menu-sub">
                        @foreach ($menu->submenu as $submenu)
                            @php
                                $subActiveClass = ($currentRouteName === $submenu->url || str_starts_with($currentRouteName, $submenu->slug)) ? 'active' : '';
                            @endphp
                            @if(auth()->user()->can($submenu->permissions))
                                <li class="menu-item {{ $subActiveClass }}">
                                    <a href="{{ route($submenu->url) }}" class="menu-link">
