...
<div class="card">
    ...
    <div class="modal fade" id="viewCommentModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ trns('comment_content') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p id="viewCommentContent" style="white-space: pre-wrap;"></p>
                </div>
                <div class="modal-footer">
            ...
            <table class="table table-bordered" id="usersTable">
                <thead>
                    <tr>
                        ...
                        <th>{{ trns('comment_creator') }}</th>
                        <th>{{ trns('post_creator') }}</th>
                        <th>{{ trns('post_image') }}</th>
                        <th>{{ trns('comment_content') }}</th>
                        <th>{{ trns('comment_reply') }}</th>
...
<script>
    $(document).ready(function() {
        ...
        /* View Comment Modal Handler */
        $(document).on('click', '.view-comment-content', function() {
            var content = $(this).data('content');
            $('#viewCommentContent').text(content);
