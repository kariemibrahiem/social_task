    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="likesModalTitle">{{ trns('Users who liked this post') }}</h5>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.show-likes-btn', function() {
            ...
            $('#likesModalBody').html('<div class="text-center"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">Loading...</span></div></div>');
            ...
            $.ajax({
                ...
                type: 'GET',
                success: function(response) {
                    $('#likesModalBody').html(response);
                },
                error: function(xhr) {
                    $('#likesModalBody').html('<p class="text-danger">Error loading likes</p>');
                }
            });
        });
